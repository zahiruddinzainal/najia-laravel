                ...
                <div class="row">
                    <div class="col-sm-7 align-self-center">
                        <div class="miwlo-app-landing-banner-text">
                            <h2 data-aos="fade-up" data-aos-delay="1000"><span style="color: #bd7d1e;">Najia</span><br>Guidance <br>On The go</h2>
                            <p data-aos="fade-up" data-aos-delay="1200">A whole lifetime skips above whatever geography <br>software beams opposite the jest the sphere elaborates!</p>
                        ...
                        <div class="miwlo-app-landing-banner-right">
                            <div class="miwlo-app-landing-banner-image miwlo-parallax">
                                <div class="mobile-wrapper">
                                    <div class="layer" data-depth="0.1">
                                        <div data-aos="fade-up" data-aos-delay="1000">
                                            <img data-parallax='{"y" : 30}' class="mobile" src="images/app.png" alt="Mobile">
                                        </div>
                                    </div><!-- .layer -->
                                </div><!-- .mobile-wrapper -->
                ...
                <div class="row">
                            ...
                            <div class="miwlo-feature-img miwlo-parallax">
                                <div class="layer" data-depth="0.1">
                                    <div data-aos="fade-up" data-aos-delay="300">
                                        <img data-parallax='{"y" : 30}' class="mobile" src="images/app.png" alt="Feature">
                                    </div>
                                </div><!-- .layer -->
                    ...
                    <div class="col-lg col-md offset-xl-2 offset-md-1 align-self-center">
                        <div class="miwlo-features-text-wrapper">
                            <h3 data-aos="fade-up" data-aos-delay="300" style="font-size: 50px;">Holistic solutions <br>for individuals, <span style="color: #bd7d1e;">mosques</span> & organisations</h3>
                    ...
                    <div class="col">
                        <div class="miwlo-download-app">
                            <div class="miwlo-download-app-text">
                                ...
                                <p data-aos="fade-up" data-aos-delay="400">A lifetime skips above whatever books<br>software beams opposite the jest</p>
                                <a data-aos="fade-up" data-aos-delay="500" class="miwlo-btn-pill btn-black" href="#">Join Now or Try Free</a>
                            </div><!-- .miwlo-download-app-text -->
                            <div class="miwlo-download-app-screenshot miwlo-parallax">
                                <div class="layer" data-depth="0.1">
                                    <div data-aos="fade-up" data-aos-delay="300">
                                        <img data-parallax='{"y" : 30}' class="mobile" src="images/banner/saas-banner-alt.png" alt="Download App">
                                    </div>
                                </div><!-- .layer -->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 align-self-center">
                        <div class="miwlo-app-testimonial-slide-container swiper-container text-center" data-aos="fade-right" data-aos-delay="300">
                            ...
                            <div class="miwlo-app-testimonial-slide-wrapper swiper-wrapper">
                                <div class="miwlo-app-testimonial-single-slide swiper-slide">
                                    ...
                                    <p>Don't judge each day by the harvest you reap but by the seeds that you plant but the majority have suffered alteration</p>
                                </div><!-- .miwlo-app-testimonial-single-slide -->
                                <div class="miwlo-app-testimonial-single-slide swiper-slide">
                                    <h4>A healthy family is sacred territory.</h4>
                                    <p>To him that you tell your secret you resign your liberty in some form those who lack the courage will always find a philosophy to justify it</p>
                                </div><!-- .miwlo-app-testimonial-single-slide -->
                                <div class="miwlo-app-testimonial-single-slide swiper-slide">
                                    <h4>You should not add oil to the fire.</h4>
                                    <p>Majority have suffered alteration in some form injected humour the essence of all art is to have pleasure in giving pleasure</p>
                                </div><!-- .miwlo-app-testimonial-single-slide -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 col-12">
                        <div class="miwlo-subscribe-text" data-aos="fade-left" data-aos-delay="300">
                            ...
                            <p>Don't judge each day by the harvest you reap but by the seeds that you plant but the majority have suffered</p>
